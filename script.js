//create const for each btn
//create function to generate actions
//create function that clears all the content
...
//show a random meme
function showMeme() {
   //Value is a string representing URL
...
//show random joke
function showJoke() {
    //Value is a string representing
    ...
    document.querySelector('.joke-content').appendChild(jokeContainer);
 }
